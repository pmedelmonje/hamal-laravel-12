            ...
            <div class="bg-white dark:bg-night-light overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-8">
                        ...
                        <h3 class="text-lg font-medium mb-4">Información de Categoría de Posts</h3>
                        <!-- Formulario para crear nuevo tipo -->
                        <div class="mt-8">
                            <h3 class="text-lg font-medium mb-4">Formulario</h3>

                            <form method="POST" action="{{ route('blog-categories-dashboard.update', $blogCategory->slug) }}" class="space-y-4">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                    ...
                                    <div class="col col-span-4 md:col-span-1">
                                        ...
                                        <input type="number" name="index" id="index" required
                                            class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-night-grey dark:text-gray-300 focus:border-star-cyan focus:ring-star-cyan rounded-md shadow-sm"
                                            value="{{ $blogCategory->index }}">
                                    </div>
                                    <div class="flex justify-start">
                                        <button type="submit" onclick="return confirm('¿Actualizar la información?')"
