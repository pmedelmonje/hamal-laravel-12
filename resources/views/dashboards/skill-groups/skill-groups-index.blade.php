        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-night-light overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <!-- Listado de grupos de habilidad -->
                    <div class="mb-8">
                        ...
                        <div class="flex justify-between items-center mb-6">
                            <h3 class="text-lg font-medium mb-4">Listado de Grupos</h3>
                            <a href="{{ route('skill-groups-dashboard.create') }}"
                                    ...
                                    @forelse($skillGroups as $group)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="{{ route('skill-groups-dashboard.show', $group->id) }}"
                                                ...
                                                <form
                                                    ...
                                                    <button type="submit" class="text-red-700 hover:text-red-300"
                                                        onclick="return confirm('¿Estás seguro de eliminar este tipo? Se eliminarán todas las habilidades asociadas.')">Eliminar</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="3"
                                                ...
                                                No se encontraron grupos de habilidad
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
