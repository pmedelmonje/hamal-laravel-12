            ...
            <div class="bg-white dark:bg-night-light overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-8">
                        ...
                        <h3 class="text-lg font-medium mb-4">Información de tipo de proyecto</h3>
                        <!-- Formulario para actualizar tipo -->
                        <div class="mt-8">
                            <h3 class="text-lg font-medium mb-4">Actualizar información</h3>

                            <form method="POST" action="{{ route('project-types-dashboard.update', $projectType->slug) }}" class="space-y-4">
                                @csrf
                                @method('PATCH')
