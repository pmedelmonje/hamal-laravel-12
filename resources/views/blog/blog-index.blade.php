            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="lg:w-1/4">
                    <div class="bg-night-grey rounded-lg p-6 border border-star-orange/30 sticky top-8">
                        ...
                        <!-- Separador -->
                        <div class="w-full h-px bg-gradient-to-r from-transparent via-star-orange to-transparent my-6"></div>
                        ...
                        <div>
                            ...
                            <ul class="space-y-3">
                                ...
                                <li>
                                    <a href="{{ route('blog.show', $post->slug) }}" class="flex items-start space-x-3 group">
                                        <div class="flex-1">
                                            <h5 class="text-star-white group-hover:text-star-orange transition-colors duration-300">{{ $post->title }}</h5>
                                            <p class="text-xs text-star-white-light/70">{{ $post->created_at->format('d M Y') }}</p>
                                        </div>
                                    </a>
                                </li>
                                @endforeach
                ...
                <div class="lg:w-3/4">
                    ...
                    <div class="space-y-8">
                        ...
                        <article class="bg-night-grey rounded-lg overflow-hidden border border-night-light hover:border-star-orange/50 transition-colors duration-300">
                            <div class="p-6 md:p-8">
                                ...
                                <h2 class="title-star-white text-2xl md:text-3xl mb-4">
                                    <a href="{{ route('blog.show', $post->slug) }}" class="hover:text-star-orange transition-colors duration-300">{{ $post->title }}</a>
                                </h2>
                                ...
                                <a href="{{ route('blog.show', $post->slug) }}" class="inline-flex items-center text-star-orange hover:text-star-orange-light transition-colors duration-300">
                                    Leer más
                        ...
                        <div class="bg-night-grey rounded-lg border border-night-light p-8 text-center">
                            <svg class="w-16 h-16 text-star-orange/50 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
